<%-- 
    Document   : share_info_addcrit
    Created on : Dec 23, 2013, 4:24:55 PM
    Author     : Hercules
--%>
...
<%
    ...
    if(id != null) {
		...
		sql = "select * from share_info where id = " + Integer.parseInt(id);
    ...
    out.println("<script>window.location.href='share_info.jsp?id=" + id + "';</script>");
%>