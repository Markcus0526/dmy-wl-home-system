...
%>
   ...
   Cookie[] cookies = request.getCookies();
    ...
    int UserId = Integer.parseInt(tmp_str, 10);
     ...
     int selectedid = Integer.parseInt(request.getParameter("id")== null?"0":request.getParameter("id"), 10);
     ...
     String groupsql = "SELECT * FROM MEMBERLOGINLIST where mid = " + selectedid;

	tmp_sql = "select * from memberinfo where id=" + selectedid;
	ResultSet rsmeminfo = null;    
	rsmeminfo = stmt.executeQuery(tmp_sql);
	String memname = "";
	if (rsmeminfo.next()) {
		memname = rsmeminfo.getString("name");
	}
	rsmeminfo.close();
...
<script type="text/javascript">
    ...
    {
		$("#from_datepicker").attr("value", "");
		$("#to_datepicker").attr("value", "");
                    ...
                    <tr>
                        ...
                        <td>
                             <div style="align:center" align="center">
                                  <form action="logindetail.jsp?id=<%=selectedid%>" method="post" id="search_form">
