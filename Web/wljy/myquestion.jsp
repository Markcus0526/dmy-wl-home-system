<%-- 
    Document   : myquestion
    Created on : 10-Dec-2013, 10:12:40
    Author     : KIMSUI
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <%
            ...
            String sql = "select count(*) as count from problem_qinfo where deleted = 0 and ISVISIBLE=1 and TO_CHAR(postdate, 'YEAR') = TO_CHAR(sysdate, 'YEAR') and mid = " + UserId;
            ...
            if (rs.next()) {
             ...
             /*   if (total_count == 0) {
                    out.println("<script>window.location.href='postquestion.jsp';</script>");
                    return;
                }*/
            ...
            int rewardintegral = 0, ans_count = 0;
        ...
        <script type="text/javascript">
            ...
            function change_page(index) {
                window.location.href = "myquestion.jsp?page=" + index;            
            }
        ...
        <div class="w964">
            ...
            <div class="site clear">
                ...
                <div class="bigmid">
                    <div class="editbtn" align="right"><a href="postquestion.jsp">我 要 提 问</a></div>
                    <div class="photoEdit">
                        <div class="myexchangetit">
                            <span style="width:180px; border-right:1px solid #e0e0e0; padding-left: 80px;">标题</span>
                            <span style="width:150px; border-right:1px solid #e0e0e0; text-align:center">悬赏积分</span>
                            <span style="width:160px; border-right:1px solid #e0e0e0; text-align:center">日期</span>
                            <span style="width:170px; text-align:center">操作</span>
                        </div>
                        <div class="myexchangelist photEditCon">
                            <ul>
                                <form action="myquestion_del.jsp" method="post" id="submit_form">
                                    <%
                                        int tmpInd = 0;
                                        while (rs.next()) {
                                            id = rs.getInt("id");
                                    ...
                                    <li class="clear">
                                        ...
                                        <span style="width:230px; overflow:hidden;white-space:nowrap;text-overflow:ellipsis;"><%=title%></span>
                                        <span class="editTit" style="width:160px; text-align:center;"><%=rewardintegral%>分</span>
                                        <span style="width:165px; text-align:center;"><%=postdate%></span>
                                        <span style="width:195px; text-align:center;"><a href="faq_info.jsp?id=<%=id%>">查看详细</a> | <a href="javascript:;" class="editDelete" onclick="delete_act('<%=id%>', '<%=title%>')">删除</a> | <a href="postquestion.jsp?id=<%=id%>">编辑</a></span>
                                    </li>
                                    <%
                                            tmpInd++;
                                        };
        ...
        <script>
            ...
            {
                if (confirm("您确定要删除你的问答'" + title + "'吗?"))
                {
                    window.location.href = "myquestion_del.jsp?id="+id;
                }
            }
