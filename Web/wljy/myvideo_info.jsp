...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <%
            ...
            String title = "", body = "", path = "", path1 = "";
            Date postdate = new Date(1, 11, 1);

            sql1 = "select * from share_data where id =" + pid;
            rs2 = stmt2.executeQuery(sql1);
            if (rs2.next()) 
			{
				int rid = rs2.getInt("rid");
				String strQuery = "Select * from share_info where id = " + rid + " and deleted = 0";
				...
				if (queryRS.next())
				{
					...
					if (path != null && path != "") 
					{
						...
						String fileExtension = path.substring(idx2 + 1);
						path1 = path.replace(fileExtension, "jpg");
					}
					else
						path1 = "img/share_img07.jpg";
					postdate = queryRS.getDate("POSTDATE");
				}				
                             ...
                             <div id="container" align="center">  
                                    ...
                                    <script type="text/javascript">
                                        jwplayer("screen").setup({
                                            ...
                                            file: "${pageContext.request.contextPath}/<%=path%>",
                                            image: "${pageContext.request.contextPath}/<%=path1%>",
                                            height: 360,
                                            width: 640
                                        });
                                    </script>
