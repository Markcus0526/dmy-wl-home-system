...
public class FaqAnswerAddActivity extends Activity {
	
	public static final String FAQANSWERADD_ID = "FAQANSWERADDID";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_nFaqid = getIntent().getIntExtra(FAQANSWERADD_ID, 0);
	...
	private void onClickSubmit()
	{
        ...
        progDialog = ProgressDialog.show(FaqAnswerAddActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "faq_info_addans.jsp";
	...
	{
        Global.showToast(FaqAnswerAddActivity.this, getString(R.string.msg_success));
		finish();
	}
