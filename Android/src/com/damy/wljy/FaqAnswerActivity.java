...
public class FaqAnswerActivity extends Activity {
	...
	public static final String FAQANSWER_ID = "FAQANSWERID";

	private ListView m_anContents = null;
	private FaqAnswerItemAdapter mAdapter = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_nFaqid = getIntent().getIntExtra(FAQANSWER_ID, 0);
		
		lab_curdate = (AutoSizeTextView)findViewById(R.id.lab_faqanswer_curdate);
		lab_curdate.setText(Global.Cur_Date + " " + Global.Cur_Weekday);
		
		LinearLayout ll_backbtn = (LinearLayout)findViewById(R.id.ll_faqanswer_backbtn);
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.anFaqAnswerContentView);
	...
	private void GetResponse()
    {
         ...
         try {
             ...
             String str_url = Global.STR_SERVER_URL + "faq_detail.jsp";
    ...
    private void getShowListFromData()
    {
    	...
    	if (mRealListView != null)
    	{
			...
			mAdapter = new FaqAnswerItemAdapter(FaqAnswerActivity.this, this.getApplicationContext());
	...
	{
		String connectUrl = Global.STR_SERVER_URL + "faq_detail.jsp?userid=" + Integer.toString(Global.Cur_UserId)
				+ "&id=" + Integer.toString(m_nFaqid) + "&page=" + Integer.toString(nCurPageNumber);
	...
	private void readContents()
	{
        ...
        progDialog = ProgressDialog.show(FaqAnswerActivity.this, "", "Waiting", true, false, null);
	...
	private void parseMainItems(JSONObject order)
	{
		try {
			...
			if ( isSuccess == 1 )
			{
				...
				m_anContents = (ListView) findViewById(R.id.anFaqAnswerContentView);
