...
public class FaqInfoActivity extends Activity {
	
	public static final String FAQINFO_ID = "FAQINFOID";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_nFaqid = getIntent().getIntExtra(FAQINFO_ID, 0);
		
		txt_title = (AutoSizeTextView)findViewById(R.id.lab_faq_info_title);
	    txt_submitter = (AutoSizeTextView)findViewById(R.id.lab_faq_info_submitter);
	    txt_integral = (AutoSizeTextView)findViewById(R.id.lab_faq_info_intergral);
	    txt_body = (AutoSizeTextView)findViewById(R.id.lab_faq_info_body);
	    txt_date = (AutoSizeTextView)findViewById(R.id.lab_faq_info_date);
	    txt_answercnt = (AutoSizeTextView)findViewById(R.id.lab_faq_info_answercnt);
	    txt_type = (AutoSizeTextView)findViewById(R.id.lab_faq_info_type);
	    txt_readcount = (AutoSizeTextView)findViewById(R.id.lab_faq_info_readcount);
	    txt_ansname = (AutoSizeTextView)findViewById(R.id.lab_faq_info_ansname);
	    txt_ansdate = (AutoSizeTextView)findViewById(R.id.lab_faq_info_ansdate);
	    txt_ansbody = (AutoSizeTextView)findViewById(R.id.lab_faq_info_ansbody);
	    txt_good = (AutoSizeTextView)findViewById(R.id.lab_faq_info_good);
	    txt_bad = (AutoSizeTextView)findViewById(R.id.lab_faq_info_bad);
	    txt_good1 = (AutoSizeTextView)findViewById(R.id.lab_faq_info_good1);
	    txt_bad1 = (AutoSizeTextView)findViewById(R.id.lab_faq_info_bad1);
	    
	    img_memimg = (ImageView)findViewById(R.id.img_faq_info_memimg);
		
	    ll_recentanswer = (LinearLayout)findViewById(R.id.ll_faq_info_recentanswer);
	    
	    bitmapNoImage = BitmapFactory.decodeResource(getResources(), R.drawable.noimage);
	    
	    AutoSizeTextView lab_curdate = (AutoSizeTextView)findViewById(R.id.lab_faq_info_curdate);
		lab_curdate.setText(Global.Cur_Date + " " + Global.Cur_Weekday);
		
		LinearLayout ll_backbtn = (LinearLayout)findViewById(R.id.ll_faq_info_backbtn);
		...
		LinearLayout ll_showanswerbtn = (LinearLayout)findViewById(R.id.ll_faq_info_showansbtn);
		...
		LinearLayout ll_addevalbtn = (LinearLayout)findViewById(R.id.ll_faq_info_addevalbtn);
		...
		LinearLayout ll_goodbtn = (LinearLayout)findViewById(R.id.ll_faq_info_upbtn);
		...
		LinearLayout ll_badbtn = (LinearLayout)findViewById(R.id.ll_faq_info_downbtn);
	...
	{
		Intent faqansadd_activity = new Intent(this, FaqAnswerAddActivity.class);
		faqansadd_activity.putExtra(FaqAnswerAddActivity.FAQANSWERADD_ID, m_nFaqid);
		startActivity(faqansadd_activity);
	}
	
	private void onClickShowAnswer()
	{
		Intent faqdetail_activity = new Intent(this, FaqAnswerActivity.class);
		faqdetail_activity.putExtra(FaqAnswerActivity.FAQANSWER_ID, m_nFaqid);
		startActivity(faqdetail_activity);
	}
	...
	private void onClickAddComment(int type)
	{
        ...
        progDialog1 = ProgressDialog.show(FaqInfoActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "faq_info_addcomment.jsp";
            param.put("userid", Integer.toString(Global.Cur_UserId));
            param.put("id", Integer.toString(m_nFaqid));
	...
	private void readContents()
	{
        ...
        progDialog = ProgressDialog.show(FaqInfoActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "faq_info.jsp";
            param.put("userid", Integer.toString(Global.Cur_UserId));
            param.put("id", Integer.toString(m_nFaqid));
	...
	private void parseMainItems(JSONObject order)
	{
		try {
			...
			if ( isSuccess == 1 )
			{
			    ...
			    txt_integral.setText("  " + order.getInt("rewardintegral"));
