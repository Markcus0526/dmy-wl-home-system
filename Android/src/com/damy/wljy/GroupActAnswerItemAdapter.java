...
class GroupActAnswerItemAdapter extends BaseAdapter {
	Context			mContext = null;
	GroupActAnswerActivity 	mActivity = null;
    private LayoutInflater mInflater;
    private Bitmap bitmapNoImage;

	public GroupActAnswerItemAdapter(GroupActAnswerActivity activity, Context context) {
    	mContext = context;
    	mActivity = activity;
