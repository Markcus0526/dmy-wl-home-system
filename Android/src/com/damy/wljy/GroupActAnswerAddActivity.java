...
public class GroupActAnswerAddActivity extends Activity {
	
	public static final String GROUPACTANSWERADD_ID = "GROUPACTANSWERADDID";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_nGropuActid = getIntent().getIntExtra(GROUPACTANSWERADD_ID, 0);
	...
	private void onClickSubmit()
	{
        ...
        progDialog = ProgressDialog.show(GroupActAnswerAddActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "activity_addanswer.jsp";
	...
	{
        Global.showToast(GroupActAnswerAddActivity.this, getString(R.string.msg_success));
		finish();
	}
