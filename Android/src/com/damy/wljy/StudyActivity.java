...
public class StudyActivity extends Activity {
	...
	private StudyItemAdapter mAdapter = null;
	
	private STStudyItemInfo m_Datas[] = null;
	...
	private ArrayList<STStudyItemInfo> actListInfo = new ArrayList<STStudyItemInfo>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lab_curdate = (AutoSizeTextView)findViewById(R.id.lab_study_curdate);
		lab_curdate.setText(Global.Cur_Date + " " + Global.Cur_Weekday);
		
		LinearLayout ll_backbtn = (LinearLayout)findViewById(R.id.ll_study_backbtn);
		...
		//readContents(0);
		  ...
		  mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.anStudyContentView);
		     ...
		     mPullRefreshListView.setOnRefreshListener(new OnRefreshListener<ListView>() {
				...
				handler = new JsonHttpResponseHandler()
		        {
		            ...
		            public void onSuccess(JSONObject object)
		            {
		                ...
		                try {
		                	actListInfo = parseStudyItems(object);	                	
		                	initContents();
		                } catch (Exception ex) {
		                    ex.printStackTrace();
		                }
	...
	{
		ll_type1 = (LinearLayout)findViewById(R.id.ll_study_type1);
		ll_type2 = (LinearLayout)findViewById(R.id.ll_study_type2);
		ll_type3 = (LinearLayout)findViewById(R.id.ll_study_type3);
		ll_type4 = (LinearLayout)findViewById(R.id.ll_study_type4);
		lab_typ1 = (AutoSizeTextView)findViewById(R.id.lab_study_type1);
		lab_typ2 = (AutoSizeTextView)findViewById(R.id.lab_study_type2);
		lab_typ3 = (AutoSizeTextView)findViewById(R.id.lab_study_type3);
		lab_typ4 = (AutoSizeTextView)findViewById(R.id.lab_study_type4);
	...
	private void onClickBack()
	{
	 ...
	 private void GetResponse()
	 {
	         ...
	         try {
	         	...
	         	String str_url = Global.STR_SERVER_URL + "study.jsp";
	 ...
	 private void getShowListFromData()
	    {
	    	...
	    	if (mRealListView != null)
	    	{
				...
				mAdapter = new StudyItemAdapter(StudyActivity.this, this.getApplicationContext());
	 ...
	 public String RequestActListWithParamNoDelay()
		{
			String connectUrl = Global.STR_SERVER_URL + "study.jsp?userid=" + Integer.toString(Global.Cur_UserId)
		...
		private ArrayList<STStudyItemInfo> parseStudyItems(JSONObject order)
		{
			ArrayList<STStudyItemInfo> retList = new ArrayList<STStudyItemInfo>();
			try {
				...
				if (isSuccess == 1) {
					...
					for (int i = 0; i < m_itemCount;i++) {
						STStudyItemInfo itemInfo = new STStudyItemInfo();
	...
	{
		STStudyItemInfo clickedItem = getItem(position - 1);
		
		Intent studyinfo_activity = new Intent(this, StudyInfoActivity.class);
		studyinfo_activity.putExtra(StudyInfoActivity.STUDYINFO_ID, clickedItem.item_id);
	...
	public STStudyItemInfo getItem(int position)
	{
	...
	private class GetDataTask extends AsyncTask<Void, Void, ArrayList<STStudyItemInfo>> {

		@Override
		protected ArrayList<STStudyItemInfo> doInBackground(Void... params) {
			...
			try {
				...
				ArrayList<STStudyItemInfo> parse_data = parseStudyItems(result);
				return parse_data;
			} catch (Exception e) {
			}
		...
		@Override
		protected void onPostExecute(ArrayList<STStudyItemInfo> result) {
			if (result != null)
			{
