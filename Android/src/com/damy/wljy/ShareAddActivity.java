...
public class ShareAddActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ll_type1 = (LinearLayout)findViewById(R.id.ll_share_add_type1);
		ll_type2 = (LinearLayout)findViewById(R.id.ll_share_add_type2);
		ll_type3 = (LinearLayout)findViewById(R.id.ll_share_add_type3);
		lab_type1 = (AutoSizeTextView)findViewById(R.id.lab_share_add_type1);
		lab_type2 = (AutoSizeTextView)findViewById(R.id.lab_share_add_type2);
		lab_type3 = (AutoSizeTextView)findViewById(R.id.lab_share_add_type3);
		...
		FrameLayout fl_submit = (FrameLayout)findViewById(R.id.fl_share_add_submitbtn);
		...
		LinearLayout ll_backbtn = (LinearLayout)findViewById(R.id.ll_share_add_backbtn);
		...
		fl_addimgframe1 = (FrameLayout)findViewById(R.id.fl_shareadd_imgframe1);
		fl_addimgframe2 = (FrameLayout)findViewById(R.id.fl_shareadd_imgframe2);
		fl_addimgframe3 = (FrameLayout)findViewById(R.id.fl_shareadd_imgframe3);
		...
		img_addimg1 = (ImageView)findViewById(R.id.img_shareadd_addimg1);
		img_addimg2 = (ImageView)findViewById(R.id.img_shareadd_addimg2);
		img_addimg3 = (ImageView)findViewById(R.id.img_shareadd_addimg3);
		
		txt_addimgtxt1 = (AutoSizeTextView)findViewById(R.id.txt_shareadd_addimgtxt1);
		txt_addimgtxt2 = (AutoSizeTextView)findViewById(R.id.txt_shareadd_addimgtxt2);
		txt_addimgtxt3 = (AutoSizeTextView)findViewById(R.id.txt_shareadd_addimgtxt3);
	...
	private void onClickFilebtn(int curImg)
	{
		...
		Intent intent = new Intent(ShareAddActivity.this, SelectPhotoActivity.class);
	...
	{
		AutoSizeEditText txt_title = (AutoSizeEditText)findViewById(R.id.txt_share_add_title);
		AutoSizeEditText txt_body = (AutoSizeEditText)findViewById(R.id.txt_share_add_body);
        ...
        progDialog = ProgressDialog.show(ShareAddActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "share_addmany.jsp";
        	param.put("userid", Integer.toString(Global.Cur_UserId));
            param.put("share_title", txt_title.getText().toString());
            param.put("share_body", txt_body.getText().toString());
            param.put("share_type", Integer.toString(m_nType));
	...
	{
        Global.showToast(ShareAddActivity.this, getString(R.string.msg_success));
		finish();
	}
