...
public class ShareEvalAddActivity extends Activity {
	
	public static final String SHAREEVALADD_ID = "SHAREEVALADDID";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_nShareid = getIntent().getIntExtra(SHAREEVALADD_ID, 0);
	...
	private void onClickSubmit()
	{
        ...
        progDialog = ProgressDialog.show(ShareEvalAddActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "share_info_addans.jsp";
	...
	{
        Global.showToast(ShareEvalAddActivity.this, getString(R.string.msg_success));
		finish();
	}
