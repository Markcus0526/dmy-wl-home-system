...
public class ShareEvalActivity extends Activity {
	
	public static final String SHAREEVAL_ID = "SHAREEVALID";

	private ListView m_anContents = null;
	private ShareEvalItemAdapter mAdapter = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_share_eval);
		
		m_nShareid = getIntent().getIntExtra(SHAREEVAL_ID, 0);
		
		lab_curdate = (AutoSizeTextView)findViewById(R.id.lab_shareeval_curdate);
		lab_curdate.setText(Global.Cur_Date + " " + Global.Cur_Weekday);
		
		LinearLayout ll_backbtn = (LinearLayout)findViewById(R.id.ll_shareeval_backbtn);
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.anShareEvalContentView);
	...
	private void GetResponse()
    {
         ...
         try {
             ...
             String str_url = Global.STR_SERVER_URL + "share_detail.jsp";
    ...
    private void getShowListFromData()
    {
    	...
    	if (mRealListView != null)
    	{
			...
			mAdapter = new ShareEvalItemAdapter(ShareEvalActivity.this, this.getApplicationContext());
	...
	{
		String connectUrl = Global.STR_SERVER_URL + "share_detail.jsp?userid=" + Integer.toString(Global.Cur_UserId)
				+ "&id=" + Integer.toString(m_nShareid) + "&page=" + Integer.toString(nCurPageNumber);
	...
	private void readContents()
	{
        ...
        progDialog = ProgressDialog.show(ShareEvalActivity.this, "", "Waiting", true, false, null);
	...
	private void parseMainItems(JSONObject order)
	{
		try {
			...
			if ( isSuccess == 1 )
			{
				...
				m_anContents = (ListView) findViewById(R.id.anShareEvalContentView);
