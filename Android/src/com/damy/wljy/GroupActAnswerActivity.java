...
public class GroupActAnswerActivity extends Activity {
	
	public static final String GROUPACTANSWER_ID = "GROUPACTANSWERID";

	private ListView m_anContents = null;
	private GroupActAnswerItemAdapter mAdapter = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_group_act_answer);
		
		m_nGropuActid = getIntent().getIntExtra(GROUPACTANSWER_ID, 0);
		
		lab_curdate = (AutoSizeTextView)findViewById(R.id.lab_groupact_answer_curdate);
		lab_curdate.setText(Global.Cur_Date + " " + Global.Cur_Weekday);
		
		LinearLayout ll_backbtn = (LinearLayout)findViewById(R.id.ll_groupact_answer_backbtn);
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.anGroupActAnswerContentView);
	...
	private void GetResponse()
    {
         ...
         try {
             ...
             String str_url = Global.STR_SERVER_URL + "activity_detail.jsp";
             param.put("userid", Integer.toString(Global.Cur_UserId));
             param.put("id", Integer.toString(m_nGropuActid));
    ...
    private void getShowListFromData()
    {
    	...
    	if (mRealListView != null)
    	{
			...
			mAdapter = new GroupActAnswerItemAdapter(GroupActAnswerActivity.this, this.getApplicationContext());
	...
	{
		String connectUrl = Global.STR_SERVER_URL + "activity_detail.jsp?userid=" + Integer.toString(Global.Cur_UserId)
				+ "&id=" + Integer.toString(m_nGropuActid) + "&page=" + Integer.toString(nCurPageNumber);
	...
	private void readContents()
	{
        ...
        progDialog = ProgressDialog.show(GroupActAnswerActivity.this, "", "Waiting", true, false, null);
	...
	private void parseMainItems(JSONObject order)
	{
		try {
			...
			if ( isSuccess == 1 )
			{
				...
				m_anContents = (ListView) findViewById(R.id.anGroupActAnswerContentView);
