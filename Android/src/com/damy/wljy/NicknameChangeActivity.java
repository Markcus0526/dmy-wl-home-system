...
public class NicknameChangeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout ll_backbtn = (LinearLayout)findViewById(R.id.ll_nickname_change_backbtn);
		...
		FrameLayout fl_submitbtn = (FrameLayout)findViewById(R.id.fl_nickname_change_submitbtn);
	...
	{
		AutoSizeEditText txt_nickname = (AutoSizeEditText)findViewById(R.id.txt_nickname_change_nickname);
        ...
        progDialog = ProgressDialog.show(NicknameChangeActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "nickname_change.jsp";
        	param.put("userid", Integer.toString(Global.Cur_UserId));
            param.put("new_nickname", txt_nickname.getText().toString());
