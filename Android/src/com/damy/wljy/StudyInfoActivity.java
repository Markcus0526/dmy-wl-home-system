...
public class StudyInfoActivity extends Activity {
	
	public static final String STUDYINFO_ID = "STUDYINFOID";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_nStudyid = getIntent().getIntExtra(STUDYINFO_ID, 0);
		
		txt_title = (AutoSizeTextView)findViewById(R.id.lab_study_info_title);
	    txt_submitter = (AutoSizeTextView)findViewById(R.id.lab_study_info_submitter);
	    txt_body = (AutoSizeTextView)findViewById(R.id.lab_study_info_body);
	    txt_date = (AutoSizeTextView)findViewById(R.id.lab_study_info_date);
	    txt_answercnt = (AutoSizeTextView)findViewById(R.id.lab_study_info_answercnt);
	    txt_type = (AutoSizeTextView)findViewById(R.id.lab_study_info_type);
	    txt_readcount = (AutoSizeTextView)findViewById(R.id.lab_study_info_readcount);
	    txt_ansname = (AutoSizeTextView)findViewById(R.id.lab_study_info_ansname);
	    txt_ansdate = (AutoSizeTextView)findViewById(R.id.lab_study_info_ansdate);
	    txt_ansbody = (AutoSizeTextView)findViewById(R.id.lab_study_info_ansbody);
	    txt_good = (AutoSizeTextView)findViewById(R.id.lab_study_info_good);
	    txt_bad = (AutoSizeTextView)findViewById(R.id.lab_study_info_bad);
	    txt_good1 = (AutoSizeTextView)findViewById(R.id.lab_study_info_good1);
	    txt_bad1 = (AutoSizeTextView)findViewById(R.id.lab_study_info_bad1);
	    
	    img_memimg = (ImageView)findViewById(R.id.img_study_info_memimg);
		
	    ll_recentanswer = (LinearLayout)findViewById(R.id.ll_study_info_recentanswer);
	    
	    bitmapNoImage = BitmapFactory.decodeResource(getResources(), R.drawable.noimage);
	    
	    AutoSizeTextView lab_curdate = (AutoSizeTextView)findViewById(R.id.lab_study_info_curdate);
		lab_curdate.setText(Global.Cur_Date + " " + Global.Cur_Weekday);
		
		LinearLayout ll_backbtn = (LinearLayout)findViewById(R.id.ll_study_info_backbtn);
		...
		LinearLayout ll_showanswerbtn = (LinearLayout)findViewById(R.id.ll_study_info_showansbtn);
		...
		LinearLayout ll_addevalbtn = (LinearLayout)findViewById(R.id.ll_study_info_addevalbtn);
		...
		LinearLayout ll_goodbtn = (LinearLayout)findViewById(R.id.ll_study_info_upbtn);
		...
		LinearLayout ll_badbtn = (LinearLayout)findViewById(R.id.ll_study_info_downbtn);
	...
	{
		Intent studyevaladd_activity = new Intent(this, StudyEvalAddActivity.class);
		studyevaladd_activity.putExtra(StudyEvalAddActivity.STUDYEVALADD_ID, m_nStudyid);
		startActivity(studyevaladd_activity);
	}
	
	private void onClickShowAnswer()
	{
		Intent studydetail_activity = new Intent(this, StudyEvalActivity.class);
		studydetail_activity.putExtra(StudyEvalActivity.STUDYEVAL_ID, m_nStudyid);
		startActivity(studydetail_activity);
	}
	...
	private void onClickAddComment(int type)
	{
        ...
        progDialog1 = ProgressDialog.show(StudyInfoActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "study_info_addcomment.jsp";
	...
	private void readContents()
	{
        ...
        progDialog = ProgressDialog.show(StudyInfoActivity.this, "", "Waiting", true, false, null);
        ...
        try {
        	...
        	String str_url = Global.STR_SERVER_URL + "study_info.jsp";
            param.put("userid", Integer.toString(Global.Cur_UserId));
            param.put("id", Integer.toString(m_nStudyid));
