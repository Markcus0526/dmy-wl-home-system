...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self != nil) {
		...
		margin = UIEdgeInsetsMake(DEFAULT_MARGIN*3, DEFAULT_MARGIN, DEFAULT_MARGIN*2, DEFAULT_MARGIN);
		padding = UIEdgeInsetsMake(DEFAULT_PADDING, DEFAULT_PADDING, DEFAULT_PADDING, DEFAULT_PADDING);
