...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        UIImage* img = [UIImage imageNamed:@"datePicker.gif"];
...
//        [self addTarget:self action:@selector(selectDate) forControlEvents:UIControlEventTouchUpInside];
        
        
        UITapGestureRecognizer *gestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(selectDate)];
