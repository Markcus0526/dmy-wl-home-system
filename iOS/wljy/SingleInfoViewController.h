...
@interface SingleInfoViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate> {
...
@property (nonatomic, assign, readwrite) NSString *evalString;
